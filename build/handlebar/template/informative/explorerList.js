...
<article data-flex-btw-cnt="" hov-dark="">
              <article data-flex-btw-cnt="" gap-1="">
                ...
                <div>
                  <h6><a href="/editor.html?id={{this._id}}">{{this.title}}</a></h6>
              ...
              <a>
                ...
                <ul class="meatballMenu" small-dark="">
                  <li rid ={{this._id}} action="get" eid="/updateOrg" ><i class="ri-pencil-fill"></i> Update</li>
                  <li><i class="ri-drag-move-2-line"></i> Move</li>
                  <li><i class="ri-file-copy-2-fill"></i> Copy</li>
                  <li rid ={{this._id}} action="get" eid="/assignRoleToOrg"><i class="ri-share-box-fill"></i> Share</li>
                  ...
                  <li  rid ={{this._id}} id="ehh-ent-org-did" action="deleteOneById" method="DELETE" ><i class="ri-delete-bin-fill"></i> Delete</li>
                </ul>
              </a>
            </article>
 {{/each}}
